...
export const MOCK_FINDINGS: StaticFinding[] = [
  { id: 'sf-001', submissionId: 'sub-007', ruleId: 'PERF-001', ruleName: 'Inefficient Collection Usage',
    severity: 'medium', category: 'suspicious', message: 'ArrayList used where LinkedList would be more efficient for frequent insertions',
  ...
  { id: 'sf-002', submissionId: 'sub-007', ruleId: 'NULL-001', ruleName: 'Potential Null Dereference',
    severity: 'high', category: 'required', message: 'Method getNeighbors() may return null when vertex does not exist',
  ...
  { id: 'sf-003', submissionId: 'sub-007', ruleId: 'STYLE-002', ruleName: 'Missing JavaDoc',
    severity: 'low', category: 'suspicious', message: 'Public method bfs() lacks documentation',
  ...
  { id: 'sf-004', submissionId: 'sub-007', ruleId: 'COMPLEX-001', ruleName: 'High Cyclomatic Complexity',
    severity: 'medium', category: 'suspicious', message: 'Method detectCycle has cyclomatic complexity of 12 (threshold: 10)',
  ...
  { id: 'sf-005', submissionId: 'sub-007', ruleId: 'RESOURCE-001', ruleName: 'Resource Leak',
    severity: 'high', category: 'required', message: 'Scanner not closed after use in readGraph()',
  ...
  { id: 'sf-100', submissionId: 'sub-013', ruleId: 'SIM-001', ruleName: 'Code Similarity Detection',
    severity: 'critical', category: 'required', message: 'High structural similarity (92%) detected with known solution repository',
  ...
  { id: 'sf-101', submissionId: 'sub-013', ruleId: 'SIM-002', ruleName: 'Unusual Code Pattern',
    severity: 'high', category: 'required', message: 'Variable naming pattern suggests copied code — identical non-obvious variable names',
  ...
  { id: 'sf-102', submissionId: 'sub-013', ruleId: 'STYLE-001', ruleName: 'Inconsistent Code Style',
    severity: 'medium', category: 'suspicious', message: 'Code style abruptly changes at line 48 — different formatting conventions',
    file: 'todo-app.ts', line: 48, column: 1 },
  { id: 'sf-103', submissionId: 'sub-013', ruleId: 'PERF-002', ruleName: 'Unnecessary Re-computation',
    severity: 'low', category: 'suspicious', message: 'Computed value recalculates on every access instead of caching',
